...
ui = fluidPage(
  ...
  navbarPage(
    ...
    tabPanel("Position Players",
             ...
             tags$p("The purpose of our
             final project is to use Hall of Fame Metric Scores to determine whether or not
             players on the suspected 2025 Hall Of Fame ballot will be forever immortalized as one of the best to ever play
             the game. We constructed a shiny app that displays the hitters Standard and Black Ink scores compared to the average
             players in the HOF. One interesting thing to note is that these scores do not
             attribute to a player's overall success but rather just hitting. HOF Monitor Scores allow us to achieve a better
             understanding of what it takes to be inducted. We will state our reasonings of why we believe some players should be inducted.
             We will account for the stats provided and include external factors such as
             steroid usage or other controversies players' may have had over their long careers. We will use our findings to support our decisions
             on why we think certain players will make the HOF. It is important to note that our metrics might be slightly
             different than the ones used on sites such as Baseball Reference.The formula for these metrics can be found at",
    ...
    tabPanel("Pitchers",
             tags$p("Authors: Kaleb Jordan & Graham Dynis"),
             tags$p("Two interesting thing to notes is that these scores do not
             attribute to a player's overall success but rather just pitching and relievers do
             not get a fair comparison to starters which negatively impacts them. HOF Monitor Scores allow us to achieve a better
             understanding of what it takes to be inducted. We will state our reasonings of why we believe some players should be inducted.
             We will account for the stats provided and include external factors such as
             steroid usage or other controversies players' may have had over their long careers. We will use our findings to support our decisions
             on why we think certain players will make the HOF. It is important to note that our metrics might be slightly
